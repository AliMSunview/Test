...
rh = window.rh;
model = rh.model;
var defaultTopic = "ChangeGear_Web/Welcome_to_ChangeGear_Web/Overview_of_ChangeGear_Web.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("ChangeGear_Web/Welcome_to_ChangeGear_Web/Overview_of_ChangeGear_Web.htm"));
rh.consts('HOME_FILEPATH', encodeURI('ChangeGear_Web.htm'));
rh.consts('START_FILEPATH', encodeURI('ChangeGear_Web.htm'));
rh.consts('HELP_ID', '4db2b219-5280-4715-9ac2-6ce2fbb25dd6' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "ChangeGear 8.3 Web Help");
